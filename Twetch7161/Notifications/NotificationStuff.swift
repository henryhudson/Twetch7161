...
//  Twetch7161
//
//  Created by Henry Hudson on 18/09/2020.
//

import SwiftUI
import os

struct NotificationStuff: View {
    @StateObject var localNotification = LocalNotification()
    @ObservedObject var notificationCenter: NotificationCenter
    
    @State var notificationTitle: String = "SMoney"
    @State var notificationUserFrom: String = "@user_number"
    @State var notificationDescription: String = "liked your post"
    var body: some View {
        VStack {
            Button("schedule Notification") {
                localNotification.setLocalNotification(title: notificationTitle,
                                                       subtitle: notificationUserFrom,
